...
void main() {
  ...
  Future<void> pumpWidget(
    ...
    OnAddIncomePressed? onAddIncomePressed,
  }) {
  ...
  group('Render', () {
    for (final locale in AppLocalizations.supportedLocales) {
      ...
      testWidgets(
        'shows IncomeCategorySelector for category with label $categoryLabel '
        'for ${locale.languageCode}',
        (tester) async {
          await pumpWidget(tester, locale: locale);
          ...
          final selectorFinder = find.ancestor(
            of: labelFinder,
            matching: find.byType(IncomeCategorySelector),
          );
          expect(selectorFinder, findsOneWidget);
        },
      );
    ...
    testWidgets(
      'submit button disabled when onAddIncomePressed null',
      (tester) async {
        // ignore: avoid_redundant_argument_values for testing purposes
        await pumpWidget(tester, onAddIncomePressed: null);
  ...
  group('Interactions', () {
    testWidgets(
      'calls onAddIncomePressed when submit button pressed',
      (tester) async {
