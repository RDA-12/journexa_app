...
final expectedTranslations = {
  'id': {
    ...
    'deleteDialogContent':
        ...
        'kategori pengeluaran name akan tetap ada. '
        'Tapi, kategori pengeluaran name tidak akan bisa digunakan lagi '
        'untuk data pengeluaran selanjutnya',
  ...
  'en': {
    ...
    'deleteDialogContent':
        'Data related to name expense category will still exist. '
        'But, name expense category will no longer be able to be used '
        'for future expense data',
...
void main() {
    ...
    for (final locale in AppLocalizations.supportedLocales) {
      ...
      group('ActionSheet - ${locale.languageCode}', () {
        Future<void> actionSheetInit(WidgetTester tester) async {
          ...
          await tester.tap(find.byType(ExpenseCategoryTile));
  ...
  group('Interactions', () {
    testWidgets(
      'shows ExpenseCategoryForm when update action pressed',
      (tester) async {
        await pumpWidget(tester);
