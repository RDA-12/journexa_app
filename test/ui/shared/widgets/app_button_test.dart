...
void main() {
  ...
  group('Render', () {
    for (final type in ButtonType.values) {
      for (final size in ButtonSize.values) {
        testWidgets('shows label for type: $type, size: $size', (tester) async {
          await pumpWidget(
            tester: tester,
            label: 'Hello',
            size: size,
        ...
        testWidgets(
          'shows icon when provided for type: $type, size: $size',
          (tester) async {
            await pumpWidget(
              tester: tester,
              label: 'Hello',
        ...
        testWidgets(
          'disabled when onPressed is null for type: $type, size: $size',
          (tester) async {
            await pumpWidget(
              tester: tester,
              label: 'Hello',
  ...
  group('Interaction', () {
    for (final type in ButtonType.values) {
      for (final size in ButtonSize.values) {
        testWidgets(
          'Calls onPressed when pressed for type: $type, size: $size',
          (tester) async {
            var isPressed = false;
            await pumpWidget(
              tester: tester,
